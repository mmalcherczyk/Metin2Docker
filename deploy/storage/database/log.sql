-- MySQL dump 10.13  Distrib 5.6.51, for FreeBSD13.2 (i386)
--
...
) ENGINE=MyISAM DEFAULT CHARSET=big5 ROW_FORMAT=FIXED;
...
CREATE TABLE `shout_log` (
  ...
  `shout` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
...
-- Dump completed on 2023-08-05 18:01:40
